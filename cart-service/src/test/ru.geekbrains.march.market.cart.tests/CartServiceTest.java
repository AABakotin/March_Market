...
//        Assertions.assertEquals(5, cartService.getCurrentCart().getItems().size());
//
//        cartService.removeOneProductById(1L);
//        Assertions.assertEquals(BigDecimal.valueOf(900), cartService.getCart().getTotalPrice());
//        Assertions.assertEquals(4, cartService.getCurrentCart().getItems().size());
//        Assertions.assertEquals(3, cartService.getCurrentCart().getItems().get(3).getQuantity());
//
...
//        Assertions.assertEquals(3, cartService.getCurrentCart().getItems().get(1).getQuantity());
//
